# Umbrella JS [![umbrellajs](https://img.shields.io/npm/v/umbrellajs?label=umbrellajs&color=greenlime)](https://www.npmjs.com/package/umbrellajs) [![test badge](https://github.com/franciscop/umbrella/workflows/tests/badge.svg)](https://github.com/franciscop/umbrella/actions) [![gzip size](https://img.badgesize.io/franciscop/umbrella/master/umbrella.min.js.svg?label=gzip&logo=&compression=gzip)](https://github.com/franciscop/umbrella/blob/master/umbrella.min.js) [![dependencies](https://img.shields.io/badge/dependencies-0-limegreen.svg)](https://github.com/franciscop/umbrella/blob/master/package.json) [![stats](https://data.jsdelivr.com/v1/package/npm/umbrellajs/badge?style=rounded)](https://www.jsdelivr.com/package/npm/umbrellajs)
